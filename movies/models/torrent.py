...
class TorrentManager(models.Manager):
    ...
    def _torrent_quality(self, torrent, created, movie):
        likes = 0
    ...
    def _find_torrent(self, movie, minimum_torrent_quality=2):
        ...
        for torrent in search:
            ...
            quality = self._torrent_quality(torrent, created, movie)
    ...
    def _add_torrent_to_transmission(self, torrent):

        tc_torrent = self.transmission.add_torrent(
    ...
    def create_for_movie(self, movie):
        rpc_torrent = self._find_torrent(movie)
        if rpc_torrent:
            transmission_torrent = self._add_torrent_to_transmission(rpc_torrent)
